...
- DONE -- Add ability to create and view a new blend.
- DONE -- One unit test.
...
## TODO
- Extract more common components such as the "Spice Label"
- More unit testing for edge cases on the API
- Ability to add blends to blends
- I kind of hate the recursive fetching for the blends that contain blends
- The searching and filtering should be done server side instead of client side
- Likely should use something like ShadCN for more common components, else make our own
- etc.
